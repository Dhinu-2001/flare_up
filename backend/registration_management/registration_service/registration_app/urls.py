...
urlpatterns = [
    ...
    path('payment/success-payment/<str:user_id>/', views.HandleSuccessPayment.as_view(), name='HandleSuccessPayment'),
    path('payment/failure-payment/<str:user_id>/', views.HandleFailurePayment.as_view(), name='HandleFailurePayment'),
