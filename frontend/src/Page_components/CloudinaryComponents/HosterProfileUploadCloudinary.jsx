...
export default function HosterProfileUploadCloudinary({ publicId, setPublicId, refreshData }) {
    ...
    const [uwConfig] = useState({
        ...
        folder: "hoster_profile_images", //u pload files to the specified folder
    ...
    return (
        <CloudinaryUploadWidget uwConfig={uwConfig} setPublicId={setPublicId} idEle={"profile"} buttonText={'Upload profile'} />
    );
}
