...
//         <CardContent>
//             <h3 className='text-3xl text-center mb-4 font-bold'>Events</h3>
...
function DashboardCard(props) {
  ...
  return (     
              <Card key={props.id} className="bg-black border-gray-700 hover:border-purple-500 transition-all">
                <CardHeader>
                  <CardTitle className="text-purple-400">{props.title}</CardTitle>
                  <CardDescription className="text-gray-400">{props.description}</CardDescription>
                </CardHeader> 
                <CardContent>
