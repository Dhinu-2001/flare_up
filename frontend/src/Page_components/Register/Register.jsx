...
export default function Register() {
  ...
  const HosterRegisterNavigation = () => {
    navigate('/hoster_register')
  }
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="flex justify-center">
            <div className="flex justify-between w-[450px] px-6 py-3">
              <h1 className="text-sm text-gray-400 hover:underline cursor-pointer" onClick={HosterRegisterNavigation}>Register as a hoster?</h1>
