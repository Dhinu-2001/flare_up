                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-2">
                      {new Intl.DateTimeFormat('en-GB', {
                        ...
                        timeStyle: 'medium',
                        hour12: true,
                      }).format(new Date(cateData.event_data.start_date_time)) }
                    </span>
                  </div>
                  <div className="flex items-center">
                    ...
                    {new Intl.DateTimeFormat('en-GB', {
                        ...
                        timeStyle: 'medium',
                        hour12: true,
                      }).format(new Date(cateData.event_data.end_date_time)) }
                    </span>
                  </div>
                  <div className="flex items-center">
                    ...
                    {new Intl.DateTimeFormat('en-GB', {
                        ...
                        timeStyle: 'medium',
                        hour12: true,
                      }).format(new Date(cateData.event_data.registration_deadline)) }
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2">
                      {cateData.event_data.payment_required
                        ? "Payment"
                        : "Free Registration"}
                    </span>
                  </div>
                  <div className="flex items-center">
                    ...
                    <span className="ml-2">
                      {cateData.event_data.payment_required
                        ? `Rs.${cateData.event_data.ticket_price}`
                        : "Nil"}
                    </span>
                  </div>
                  <div className="flex items-center">
                    ...
                    <span className="ml-2">
                      {cateData.event_data.participant_capacity} spots available
                    </span>
                  </div>
                </div>
              </CardContent>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2">
                        {cateData.event_data.address_line_1}
                      </span>
                    </div>
                    <div className="flex items-center">
                      <span className="font-medium">City:</span>
                      <span className="ml-2">{cateData.event_data.city}</span>
                    </div>
                    <div className="flex items-center">
                      <span className="font-medium">State:</span>
                      <span className="ml-2">{cateData.event_data.state}</span>
                    </div>
                    <div className="flex items-center">
              ...
              <CardHeader>
                <CardTitle className="flex justify-between">
                  ...
                  <div className=" text-sm text-gray-600">
                    <Link
                      to={`/hoster/event/${cateData.event_data.id}/add_participants_sponsers`}
                    >
                ...
                {participants.length === 0 ? (
                  ...
                  <ul className="space-y-4">
                    {participants.map((participant) => (
                      <li
                        key={participant.id}
                        className="flex items-center justify-between border bg-zinc-900 p-4 rounded-lg"
                      >
              ...
              <CardContent>
                ...
                <div className="text-sm text-gray-500 mt-2">
                  ...
                  {new Intl.DateTimeFormat('en-GB', {
                        ...
                        timeStyle: 'medium',
                        hour12: true,
                      }).format(new Date(cateData.event_data.updated_at)) }
                </div>
                <div className="mt-8 gap-2">
                  {cateData.event_data.status != "Cancelled by Admin" &&
                    (cateData.event_data.status_request ? (
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          onClick={() =>
                            handleEventStatus("Cancel status request")
                          }
                        >
                          Cancel request
                        </Button>
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            onClick={() => handleEventStatus("Cancelled")}
                          >
                            Cancel event
                          </Button>
                        </div>
                        {cateData.event_data.approval_status ===
                        "Waiting for approval" ? (
                          ""
                        ) : (
                          <p className="text-sm text-gray-500 mt-2">
                            The event will be cancelled on admin's active
                            approval.
                          </p>
                        )}
                      </div>
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <Button onClick={() => handleEventStatus("Active")}>
                            Active event
                          </Button>
                        </div>
                        {cateData.event_data.approval_status ===
                        "Waiting for approval" ? (
                          ...
                          <p className="text-sm text-gray-500 mt-2">
                            The event will be active on admin's active approval.
                          </p>
                        )}
                      </div>
                    ))}
              ...
              <CardContent>
                ...
                <div className="text-sm text-gray-500 mt-2">
                  ...
                  {new Intl.DateTimeFormat('en-GB', {
                        ...
                        timeStyle: 'medium',
                        hour12: true,
                      }).format(new Date(cateData.event_data.approval_updated_at)) }
                </div>
              </CardContent>
            </Card>
          </div>
