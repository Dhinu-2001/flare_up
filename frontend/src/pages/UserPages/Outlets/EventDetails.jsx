  ...
  return (
    <div className="min-h-screen bg-black text-white py-20 px-4 md:px-6">
      ...
      <div className="relative">
        ...
        <AdvancedImage
          cldImg={myImage(eventData.event_data.banner_image)}
        ...
        <Link to={`/chat/${eventData.user_data.id}/`}>
          ...
          >
            <MessageCircle
              className={`h-6 w-6 text-background transition-transform ${
            ...
            <CardContent>
              <div className="space-y-2 mb-10">
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    {new Date(
                      eventData.event_data.start_date_time
                    ).toLocaleString()}
                  </span>
                </div>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    {new Date(
                      eventData.event_data.end_date_time
                    ).toLocaleString()}
                  </span>
                </div>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    {new Date(
                      eventData.event_data.registration_deadline
                    ).toLocaleString()}
                  </span>
                </div>
              </div>
              <h2 className="text-2xl font-semibold ml-0 m-4 ">
                Event Address
              </h2>
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    {eventData.event_data.address_line_1}
                  </span>
                </div>
                <div className="flex items-center">
      ...
      <div className="my-5">
        <ParticipantCarousel
          participants={eventData?.event_data?.key_participants}
        />
      </div>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              /> */}
              <video className="w-full h-2/3 object-cover rounded-md" controls>
                <source
                  src={`https://res.cloudinary.com/dzwjm8n8v/video/upload/v1731568818/${eventData.event_data.promo_video}.mp4`}
                />
                Your browser does not support the video tag.
            ...
            <div>
              ...
              <Card className="bg-black p-6">
                <div className="grid gap-6">
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          ...
                          <span className="ml-2">
                            {eventData.event_data.payment_required
                              ? "Payment"
                              : "Free Registration"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          ...
                          <span className="ml-2">
                            {eventData.event_data.payment_required
                              ? `Rs.${eventData.event_data.ticket_price}`
                              : "Nil"}
                          </span>
                        </div>
                        <div className="flex items-center">
                          ...
                          <span className="ml-2">
                            {eventData.event_data.participant_capacity} spots
                            available
                          </span>
                        </div>
                      </div>
                  ...
                  <Link
                    to={`/catgory/${eventData.event_data.category}/${eventData.event_data.type}/${eventData.event_data.id}/ticket_registration`}
                  >
